...
export default function App() {
  ...
  const weekendProjects = [
    { id: "whiteboard", title: "Collaborative Whiteboard", description: "Real-time shared drawing space using optimistic UI updates and sub-50ms WebSocket broadcast architecture.", icon: Edit3, color: "bg-[#95ADB6]", tags: ["Socket.io", "Canvas API", "React", "Node.js"], live: "#", repo: "https://github.com/sadzebra/collaborative-whiteboard" },
    { id: "movie-finder", title: "Movie Finder", description: "High-performance discovery engine with real-time search and cinema data visualization.", icon: Film, color: "bg-[#CBB3BF]", tags: ["React", "TMDB API", "Vite", "Tailwind CSS"], live: "#", repo: "https://github.com/sadzebra/movies-finder" },
    { id: "roaster", title: "Code Roaster", description: "AI-powered feedback engine using Google's Gemini API and custom persona engineering.", icon: Coffee, color: "bg-[#EF959C]", tags: ["Gemini API", "Prompt Engineering", "Express", "Docker"], live: "#", repo: "https://github.com/sadzebra/roasted-code" },
    { id: "lab-4", title: "System Monitor", description: "Real-time dashboard for cloud infrastructure monitoring and alerting.", icon: Binary, color: "bg-[#8DA1B9]", tags: ["Go", "gRPC", "Prometheus"], live: "#", repo: "#" },
    { id: "lab-5", title: "Logic Flow", description: "A visual programming environment for automated workflow generation.", icon: Box, color: "bg-[#DBC7BE]", tags: ["React Flow", "Zustand", "Node.js"], live: "#", repo: "#" }
  ];
